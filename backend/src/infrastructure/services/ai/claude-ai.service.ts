...
export class ClaudeAIService implements IAIService {
  ...
  /**
   * Analisa uma descrição textual de alimentos
   */
  async analyzeFoodDescription(description: string): Promise<FoodAnalysisResult> {
...
Exemplo de resposta válida:
{
  ...
  /**
   * Retorna o prompt para análise de descrição textual de alimentos
   */
