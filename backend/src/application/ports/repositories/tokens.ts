/**
 * Tokens de Injeção de Dependência para Repositórios
 * Usados pelo NestJS para resolver dependências com interfaces
 */

export const USER_REPOSITORY_TOKEN = 'IUserRepository';
export const MEAL_REPOSITORY_TOKEN = 'IMealRepository';
